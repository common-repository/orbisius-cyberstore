...
Start selling your digital products such as software, e-books, reports in minutes with a simple Buy Now button.
If the price is set to 0 users will see a Download button and will be offered a to download the file.
...
=  2.1.8 =
* Tested with WP
* refactored code to use a different method to verify the IPN
* Will create an empty index.html to prevent file listing.
